...
(() => {
  ...
  function addCustomButtons() {
    ...
    refreshBtn.style.cssText = 'border: none; cursor: pointer; display: flex; justify-content: center; align-items: center;';
    ...
    settingsBtn.style.cssText = 'border: none; cursor: pointer; padding: 4px; outline: none; display: flex; justify-content: center; align-items: center;';
    applyThemeStyles(settingsBtn, { square: true });
    ...
    settingsSvg.style.width = '20px';
    settingsSvg.style.height = '20px';
    ...
    settingsDropdown.style.cssText = 'position: fixed; bottom: 80px; right: 20px; z-index: 10000; border: 1px solid currentColor; border-radius: 8px; display: none; flex-direction: column; min-width: 250px; box-shadow: 0 4px 6px rgba(0,0,0,0.1); overflow: hidden;';
    applyThemeSurface(settingsDropdown);
